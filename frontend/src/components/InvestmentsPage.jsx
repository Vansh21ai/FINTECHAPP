...
const InvestmentsPage = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <iframe
        src="https://my.spline.design/coin-7b3a2d49ca607e4d27b5e3e74fca0c52/"
        frameBorder="0"
      ...
      {/* ── Overlay ── */}
      <div className="absolute inset-0 z-[1] bg-gradient-to-b from-slate-900/65 via-slate-900/30 to-slate-900/75 pointer-events-none" />
      ...
      <div className="relative z-10 min-h-screen p-4 md:p-6 lg:p-8 flex flex-col max-w-[1200px] mx-auto">
        ...
        <Link
          to="/"
          className="self-start inline-flex items-center gap-2 px-4 py-2 bg-white/20 hover:bg-white/30 backdrop-blur-md rounded-xl border border-white/40 text-white font-bold text-sm shadow-sm transition-all hover:pr-5 group mb-4"
        >
        ...
        {/* Live Ticker Banner */}
        <div className="glass-panel px-5 py-3 mb-5 flex items-center gap-4 overflow-hidden">
        ...
        {/* Summary strip */}
        <div className="glass-panel p-5 mb-5 grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
        ...
        <div className="flex flex-col lg:flex-row gap-5 flex-1">
          ...
          <div className="w-full lg:w-1/2 glass-panel p-5">
